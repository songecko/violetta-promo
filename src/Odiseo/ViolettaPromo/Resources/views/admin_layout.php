			...
			<div class="panel panel-default">
			 	<div class="panel-body">
				 	<ul class="nav nav-pills">
		 				<li><a href="<?php echo $view['router']->generate('backend_user_index') ?>">Registros</a></li>
		 				<li><a href="<?php echo $view['router']->generate('backend_user_download_excel') ?>">Exportar XLS</a></li>
					</ul>
				</div>
			</div>
    		<?php echo $content ?>
